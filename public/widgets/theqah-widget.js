    ...
    const style = h("style", {
      html: `
        ...
        * { box-sizing: border-box; }
        ...
        /* ——— لوجو الهيدر: ثابت (لا تكبير إضافي) ——— */
        .logo { 
          width: 96px; 
          height: 96px; 
          border-radius: 10px;
        ...
        .stars { color: #f59e0b; letter-spacing: 1px; font-size: 18px; filter: drop-shadow(0 1px 2px rgba(245, 158, 11, 0.2)); }
        ...
        .badge { 
          ...
          font-weight: 900;
          padding: 14px 22px;     /* مساحة أكبر */
          border-radius: 34px;
          box-shadow: ${theme === "dark" ? "0 6px 12px -3px rgba(0,0,0,.35)" : "0 6px 12px -3px rgba(0,0,0,.08)"};
          white-space: nowrap;
        }
        /* تأكيد مقاس اللوجو 70px بأولوية عالية */
        .badge > .badge-logo,
        ...
        .badge .label { letter-spacing: .2px; }

        .text { white-space: pre-wrap; line-height: 1.7; font-size: 15px; margin: 16px 0 0 0; color: ${theme === "dark" ? "#e2e8f0" : "#374151"}; letter-spacing: -0.01em; }

        .empty { padding: 32px; border: 2px dashed ${theme === "dark" ? "#475569" : "#cbd5e1"}; border-radius: 16px; font-size: 15px; opacity: .8; text-align: center; background: ${theme === "dark" ? "rgba(15, 23, 42, 0.3)" : "rgba(248, 250, 252, 0.5)"}; }

        .row { display: flex; align-items: center; gap: 12px; justify-content: space-between; flex-wrap: wrap; }
        .left { display: flex; align-items: center; gap: 12px; }

        .item { 
          background: ${theme === "dark" ? "linear-gradient(135deg, rgba(15, 23, 42, 0.8) 0%, rgba(30, 41, 59, 0.4) 100%)" : "linear-gradient(135deg, #ffffff 0%, rgba(248, 250, 252, 0.8) 100%)"};
          color: inherit; 
          border: 1px solid ${theme === "dark" ? "rgba(71, 85, 105, 0.3)" : "rgba(226, 232, 240, 0.6)"};
          border-radius: 18px; 
          padding: 24px; 
          margin: 16px 0;
          box-shadow: ${theme === "dark" ? "0 10px 25px -5px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.05)" : "0 10px 25px -5px rgba(0, 0, 0, 0.04), 0 0 0 1px rgba(255, 255, 255, 0.1)"}; 
        ...
        .item::before {
          ...
          background: linear-gradient(90deg, transparent, ${theme === "dark" ? "rgba(255,255,255,.03)" : "rgba(59,130,246,.03)"}, transparent);
          transition: left .6s;
        }
        .item:hover::before { left: 100%; }
        .item:hover { transform: translateY(-2px); border-color: ${theme === "dark" ? "rgba(59,130,246,.3)" : "rgba(59,130,246,.2)"}; }
        ...
        .filter button { padding: 10px 20px; border-radius: 12px; border: 1px solid ${theme === "dark" ? "rgba(71, 85, 105, 0.4)" : "rgba(203, 213, 225, 0.8)"}; background: ${theme === "dark" ? "rgba(15, 23, 42, 0.6)" : "rgba(255, 255, 255, 0.8)"}; color: inherit; cursor: pointer; font-weight: 500; font-size: 13px; transition: all .2s ease; backdrop-filter: blur(8px); }
        ...
        .loading::after { content:''; display:inline-block; width:20px; height:20px; margin-left:12px; border:2px solid ${theme === "dark" ? "#475569" : "#cbd5e1"}; border-radius:50%; border-top-color:#3b82f6; animation: spin 1s linear infinite; vertical-align: middle; }
