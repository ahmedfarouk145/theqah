  ...
  const faqs = [
    {
      ...
      a: 'من سوق تطبيقات سلة، ثبّت تطبيق "مشتري موثق" وفعّله، وسيتم الربط تلقائيًا دون الحاجة لأي إعدادات إضافية.',
    },
    {
      q: 'كيف يتم توثيق التقييمات؟',
      a: 'بعد أن يترك العميل تقييمه على متجرك في سلة، نستقبل التقييم تلقائيًا ونتحقق من صحة الطلب، ثم يمرّ عبر الفلترة بالذكاء الاصطناعي. إذا اجتاز الفحص تظهر عليه شارة "مشتري موثق" فورًا.',
    },
    {
