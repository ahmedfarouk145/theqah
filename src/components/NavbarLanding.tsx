...
export default function NavbarLanding() {
  ...
  const NavLinks = (
    <>
      <Link href="/blog" className="hover:text-green-900 transition">المدونة</Link>
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-[80vw] sm:w-[360px]">
              <div className="mt-8 space-y-4 text-green-800 font-medium text-base">
                ...
                <Link href="/blog" onClick={() => setOpen(false)} className="block hover:text-green-900 transition">المدونة</Link>
